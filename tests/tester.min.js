...
`);const d=document.createElement("code-input");document.body.append(d),d.focus(),document.execCommand("insertText",!1,"Hello, World!"),assertEqual("Core","Programmatically-created element JS-accessible value",d.value,"Hello, World!"),await waitAsync(50),assertEqual("Core","Programmatically-created element rendered value",d.preElement.textContent,"Hello, World!\n");let e=0,f=0,g=a=>{a.isTrusted||e++};codeInputElement.addEventListener("input",g);let h=()=>{f++};codeInputElement.addEventListener("change",h);let i=!1,j=()=>{i=!0};codeInputElement.addEventListener("input",j),codeInputElement.removeEventListener("input",j),a.focus(),addText(a," // Hi"),a.blur(),a.focus(),assertEqual("Core","Function Event Listeners: Input Called Right Number of Times",e,6),assertEqual("Core","Function Event Listeners: Change Called Right Number of Times",f,1),testAssertion("Core","Function Event Listeners: Input Removed Listener Not Called",!i,"(code-input element).removeEventListener did not work."),codeInputElement.removeEventListener("input",g),codeInputElement.removeEventListener("change",h),e=0,f=0,codeInputElement.addEventListener("input",{handleEvent:a=>{a.isTrusted||e++}}),codeInputElement.addEventListener("change",{handleEvent:()=>{f++}}),i=!1,j={handleEvent:()=>{i=!0}},codeInputElement.addEventListener("input",j),codeInputElement.removeEventListener("input",j),a.focus(),addText(a," // Hi"),a.blur(),a.focus(),assertEqual("Core","Object Event Listeners: Input Called Right Number of Times",e,6),assertEqual("Core","Object Event Listeners: Change Called Right Number of Times",f,1),testAssertion("Core","Object Event Listeners: Input Removed Listener Not Called",!i,"(code-input element).removeEventListener did not work."),b||(testAssertion("Core","Language attribute Initial value",!codeInputElement.codeElement.classList.contains("language-javascript")&&!codeInputElement.codeElement.classList.contains("language-html"),`Language unset but code element's class name is ${codeInputElement.codeElement.className}.`),codeInputElement.setAttribute("language","HTML"),await waitAsync(50),testAssertion("Core","Language attribute Changed value 1",codeInputElement.codeElement.classList.contains("language-html")&&!codeInputElement.codeElement.classList.contains("language-javascript"),`Language set to HTML but code element's class name is ${codeInputElement.codeElement.className}.`),codeInputElement.setAttribute("language","JavaScript"),await waitAsync(50),testAssertion("Core","Language attribute Changed value 2",codeInputElement.codeElement.classList.contains("language-javascript")&&!codeInputElement.codeElement.classList.contains("language-html"),`Language set to JavaScript but code element's class name is ${codeInputElement.codeElement.className}.`));let k=codeInputElement.parentElement;k.reset(),await waitAsync(50),assertEqual("Core","Form Reset resets Code-Input Value",codeInputElement.value,`console.log("Hello, World!");
// A second line
