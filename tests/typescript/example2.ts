...
const plugins1: Array<codeInput.Plugin> = [
...
const plugins2: Array<codeInput.Plugin> = [
    new AutoCloseBrackets(),
...
const hljsTemplate: codeInput.Template = new HLJSTemplate(stubHLJS, plugins1);
const prismTemplate: codeInput.Template = new PrismTemplate(stubPrism, plugins2);

codeInput.registerTemplate("hljs", hljsTemplate);
codeInput.registerTemplate("prism", prismTemplate);
